...
//stale do funkcji checkIfPossibleChar
...
const int MIN_PIXEL_AREA = 5;

//stale do porownania dwoch znakow
...
const int RESIZED_CHAR_IMAGE_WIDTH = 30;
const int RESIZED_CHAR_IMAGE_HEIGHT = 40;

const int MIN_CONTOUR_AREA = 100;

//zewnetrzne zmienne globalne
